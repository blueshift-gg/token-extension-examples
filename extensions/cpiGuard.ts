...
async function disableAndEnableCpiGuard(connection: Connection, keypair: Keypair, tokenAccount: PublicKey) {
    ...
    console.log(`CPI guard disabled and enabled! Check out your TX here: https://explorer.solana.com/tx/${signature}?cluster=devnet`);
}
...
(async () => {
    try {
        ...
        // Disable and enable CPI guard
        await disableAndEnableCpiGuard(connection, keypair, tokenAccount.publicKey);
    } catch(e) {
